...
1. Selecione **Executar layout** na janela pop-up *Iniciar rotulagem agora* e aguarde a conclusão da análise.
...
1. No Estúdio de IA do Azure para Informação de Documentos, selecione a página **Test**, selecione **TaxFormsModel** no menu suspenso.
